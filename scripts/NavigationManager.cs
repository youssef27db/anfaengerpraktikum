...
/**
 * @brief Der NavigationManager ist für das Laden von Leveln und das Spawnen des Spielers verantwortlich.
...
public partial class NavigationManager : Node
{
    ...
    /**
     * @brief Das Signal, das ausgelöst wird, wenn der Spieler spawnen soll.
    ...
    /**
     * @brief Initialisiert den NavigationManager und setzt ihn als Singleton.
     */
    ...
    /**
     * @brief Lädt das angegebene Level und setzt das Ziel-Tag für den Spieler-Spawn.
    ...
    /**
     * @brief Diese Methode wird aufgerufen, um die Szene zu wechseln.
